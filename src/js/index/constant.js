const TREM = {
  constant: {
    ...
    AUDIO: {
      ...
      EEW: new Audio('../audio/EEW.mp3'),
      INTENSITY: new Audio('../audio/INTENSITY.mp3'),
      PGA1: new Audio('../audio/PGA1.mp3'),
      PGA2: new Audio('../audio/PGA2.mp3'),
      REPORT: new Audio('../audio/REPORT.mp3'),
      SHINDO0: new Audio('../audio/SHINDO0.mp3'),
      SHINDO1: new Audio('../audio/SHINDO1.mp3'),
      SHINDO2: new Audio('../audio/SHINDO2.mp3'),
      TSUNAMI: new Audio('../audio/TSUNAMI.mp3'),
      UPDATE: new Audio('../audio/UPDATE.mp3'),
