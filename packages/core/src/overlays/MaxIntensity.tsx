...
export function MaxIntensity() {
  ...
  return (
    <div
      className="pointer-events-none absolute left-1 top-[9.3rem] z-[1000] flex flex-col text-center text-[11px] font-medium leading-none"
      style={{ color: "var(--light)" }}
    >
      {/* 最大觀測震度 */}
      <div
        className="flex flex-col items-center rounded-[5px] p-2 gap-2"
        style={{
      ...
      >
        <span className="text-[14px] py-1">最大加速度</span>
        <div
